            ...
            <div className={`flex-1 flex flex-col overflow-hidden transition-all duration-300 ${mainContentMargin}`}>
                <header className="flex-shrink-0 flex items-center justify-between px-6 py-4 bg-white border-b-2 border-gray-200">
                    <div className="flex items-center">
                        ...
                        <button onClick={() => setDesktopSidebarCollapsed(!isDesktopSidebarCollapsed)} className="text-gray-500 focus:outline-none hidden lg:block mr-4">
                           <Icons.MenuIcon className="w-6 h-6" />
                        </button>
                        <Link to="/" className="text-sm font-semibold text-gray-600 hover:text-black flex items-center">
