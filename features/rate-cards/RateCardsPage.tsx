    ...
    return (
        <div>
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-gray-800 font-heading">Rate Cards</h1>
                    <p className="text-gray-600">Manage your service rate cards across different regions.</p>
                </div>
            ...
            <div className="mb-6 p-6 bg-white rounded-lg shadow-custom-light">
                <div className="relative">
                    ...
                    <input
                        ...
                        className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-primary-main focus:border-primary-main sm:text-sm"
                    />
                </div>
            </div>
